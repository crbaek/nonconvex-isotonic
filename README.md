...
rather than `nonconvec_isotonic`.  The latter has a typo and the underscore style is less standard for public academic repositories.  A longer alternative is `crbaek/nonconvex-isotonic-regression`.
